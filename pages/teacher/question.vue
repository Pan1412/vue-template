  ...
  <div class="container mt-4 p-4 mb-5 bg-white shadow rounded">
    ...
    <div class="d-flex justify-content-end mb-2">
      <button class="btn btn-outline-success btn-sm   px-6 py-6 "  @click="StandardScore">
        <Icon name="mdi:numeric-1-box-multiple" class="icon-status" style="font-size: 1.5rem; margin-top: -2px;" /> คะแนนพื้นฐาน</button>
    </div>
        ...
        <tbody class="fm-IBM">
          <tr v-for="q in questions" :key="q.id">
            ...
            <td class="text-center centerButton" >
              ...
              <!-- <input type="radio" :name="'q' + q.id" :value="q.values[0]" v-model="q.value" class="form-check-input" /> -->
            </td>
            <td class="text-center centerButton">
              <label class="container2 ">
              ...
              <!-- <input type="radio" :name="'q' + q.id" :value="q.values[1]" v-model="q.value" class="form-check-input" /> -->
            </td>
            <td class="text-center centerButton">
              <label class="container2 ">
              ...
              <!-- <input type="radio" :name="'q' + q.id" :value="q.values[2]" v-model="q.value" class="form-check-input" /> -->
            </td>
          </tr>
        </tbody>
      </table>
...
export default {
  ...
  methods: {
      ...
      try {
        ...
        .then((response) => {
          if (response.result) {
            ...
            q.value = result[`Q${q.id}`]; // ไม่ต้องแปลงค่าแล้ว
          });
    ...
    async submitForm() {
      ...
      if(res.result[0].teacher_status){
